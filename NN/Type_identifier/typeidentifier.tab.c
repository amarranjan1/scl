...
#ifndef YY_YY_TYPEIDENTIFIER_TAB_H_INCLUDED
# define YY_YY_TYPEIDENTIFIER_TAB_H_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
...
#endif /* !YY_YY_TYPEIDENTIFIER_TAB_H_INCLUDED  */

/* Second part of user prologue.  */
#line 8 "typeidentifier.y"
...
yyreduce:
  ...
  switch (yyn)
    {
  case 4:
#line 37 "typeidentifier.y"
                       { printf("%s \n",(yyvsp[-1].padainfo).word); }
#line 1321 "typeidentifier.tab.c"
    break;

  case 5:
#line 40 "typeidentifier.y"
                                        {
                                         strcpy(type,"@R");
